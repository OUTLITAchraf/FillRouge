...
<head>
    ...
    <style>
        ...
        .provider-details th, .provider-details td {
            padding: 14px 20px;
            text-align: left;
        ...
        .cta-button {
            ...
            background: linear-gradient(135deg, #F39C12 0%, #E67E22 100%);
            color: #FFFFFF !important; /* Added !important for link styles */
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p class="message">
                A new provider has successfully registered an account and is awaiting <span class="highlight">Provider approval</span>. 
            ...
            <p class="message">
                **Action Required:** Log in to your admin panel to verify the provider's information and complete the approval process.
            </p>
