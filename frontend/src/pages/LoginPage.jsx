...
const LoginPage = () => {
    ...
    return (
        <div className="h-screen flex flex-col lg:flex-row bg-gradient-to-br from-green-50 via-white to-green-50 overflow-y-auto lg:overflow-hidden">
            ...
            <div
                className="bg-gradient-to-br from-[#2ECC71] to-[#27AE60] text-white py-12 px-4 sm:px-6 lg:px-8 shadow-xl lg:w-1/2 lg:flex lg:flex-col lg:items-center lg:justify-center lg:h-full"
            >
                <div className="max-w-xl mx-auto">
                    ...
                    <div className="flex items-center gap-4 mb-8 justify-center lg:justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-green-100 text-lg">Log in to manage your profile, services, or bookings.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 lg:grid-cols-1 gap-4 max-w-4xl mx-auto lg:max-w-none">
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center md:text-left hover:bg-white/20 transition-all lg:text-center">
                            ...
                            <p className="text-xs opacity-90">Your data is protected with industry-standard encryption.</p>
                        </div>

                        {/* Benefit 2 */}
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center md:text-left hover:bg-white/20 transition-all lg:text-center">
                            <Shield className="w-8 h-8 mb-2 mx-auto md:mx-0 lg:mx-auto" />
                            <h3 className="font-semibold text-base mb-1">Centralized Management</h3>
                            <p className="text-xs opacity-90">Access your dedicated dashboard to manage appointments, projects, or requests.</p>
                        </div>

                        {/* Benefit 3 */}
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center md:text-left hover:bg-white/20 transition-all lg:text-center">
                            <Activity className="w-8 h-8 mb-2 mx-auto md:mx-0 lg:mx-auto" />
                            <h3 className="font-semibold text-base mb-1">Real-Time Notifications</h3>
                            <p className="text-xs opacity-90">Stay informed with instant updates regarding your account activity.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div
                className="flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 lg:w-1/2 lg:overflow-y-auto lg:h-full lg:flex-grow"
            >
                <div className="w-full max-w-md mx-auto"> 
                    <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8">
                        <div className="mb-6">
                            <h1 className="text-3xl font-bold text-[#2C3E50] mb-2">Sign In to Fidarek</h1>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <div className="text-center pt-4">
                                ...
                                <p className="text-gray-600">
                                    Create Account as {' '}
                                    <Link to="/user/register" className="text-[#2ECC71] hover:text-[#27AE60] font-bold">
                                        User
                                    </Link>
                                    {' '} or {' '}
                                    <Link to="/provider/register" className="text-[#E67E22] hover:text-[#D35400] font-bold">
                                        Provider
                                    </Link>
                                </p>
                            </div>
