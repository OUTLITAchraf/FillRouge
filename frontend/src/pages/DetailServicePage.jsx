            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <StarRating rating={rating} interactive={true} size={28} />
                </div>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="font-semibold text-lg text-[#2C3E50]">
                          {review.client_id == user?.id ? "You" : review?.user?.name}
                        </h3>
                        <p className="text-sm text-gray-500">{review.created_at.split('T')[0]}</p>
                      </div>
                      <div className="flex items-center gap-3">
